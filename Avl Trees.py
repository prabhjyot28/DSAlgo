...
tree.insert(2)
tree.insert(4)
tree.find(2)     # return the node with key 2 if present else None.
tree.find_min()   # return node with min value.
tree.delete(1)   # delete node with given key from tree if present
